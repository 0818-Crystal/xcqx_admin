...
import { List, Datagrid, TextField,Edit,SimpleForm,Filter,DateInput,ReferenceField ,DateField,EditButton,TextInput} from 'react-admin';
...
export const UserList = props => (
    <List {...props} sort={{ field: 'id', order: 'DESC' }} filters={<UserFilter />} exporter={UserExporter}>
        <Datagrid rowClick="edit"  >
            ...
            <TextField source="followerState" label='关注状态'/>
