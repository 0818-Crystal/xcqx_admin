...
import { List, Datagrid, TextField, NumberField,Edit,EditButton,SimpleForm,TextInput,Create,NumberInput} from 'react-admin';
...
export const IntegralItemList = props => (
    <List {...props} sort={{ field: 'id', order: 'ASC' }} >
        <Datagrid rowClick="edit">
            ...
            <TextField source="integralUrl" label={'跳转链接'}/>
